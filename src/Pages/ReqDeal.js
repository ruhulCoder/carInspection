...
const ReqDeal = () => {
            ...
            <>
                <Form>
                    <Form.Item>
                        ...
                        >
                            <Input placeholder="Dealership Contact Person"/>
                        </Form.Item>
                        <Form.Item
                            style={{
                            display: 'inline-block',
                            ...
                            <Col>
                                ...
                                <Row>
                                    <Col style={{marginTop: 10}}>
                                        ...
                                        <Checkbox value="d1">Safety Inspection - $100</Checkbox>
                                        <Checkbox value="d2" style={{marginLeft: 233}}>Pre-Purchase Inspection - $150</Checkbox>
                                        </Col>
                                    </Col>
                                </Row>
                                ...
                                <Row>
                                    <Col>
                                        <h4 style={{marginTop: 10}}>Don't have time? Request our Concierge Service</h4>
                                        <Col style={{marginBottom: 10}}>
                                            <Checkbox value="l1">Concierge Service - $100</Checkbox>
                                        </Col>
                                        <label>We will pick up & drop off your car.</label>
                                    </Col>
                                </Row>
                            </Col>
                        </Checkbox.Group>
  ...
  return (
    <>
        <Button type="button" onClick={() => setModalOpen(true)} className='reqind'>Request Inspection - Dealerships</Button>
        <Modal 
            centered
            open={modalOpen}
            ...
            width={800}
            >
                <label className='formtitle'>Inspection Request Form – Dealership</label>
                <br/>
