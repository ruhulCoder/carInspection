...
const ReqUber = () => {
  ...
  return (
    <>
        <Button type="button" onClick={() => setModalOpen(true)} className='reqind'>Request Inspection - Uber</Button>
        <Modal 
            centered
            open={modalOpen}
            ...
            width={800}
            >
                <label className='formtitle'>Inspection Request Form – Uber</label>
                <br/>
